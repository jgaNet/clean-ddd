...
import { Result, QueriesService, Event } from '@Core/Domain';

import { QueryHandler, CommandEvent, CommandHandler, EventHandler } from '@Core/Application';
import { EventBus, DataSource } from '@Core/Domain/Services';
